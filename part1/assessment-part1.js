...
// Object.defineProperty(String.prototype, 'grammarPolice', {
//   value: function() {
//     return this.charAt(0).toUpperCase() + this.slice(1) + this.split(' ');
//   },
//   writable: true,
//   configurable: true
// });
...
// try {
//   var result = promiseCatcher(param)
// } catch(e) {
//   var theAnswer = result;
// }